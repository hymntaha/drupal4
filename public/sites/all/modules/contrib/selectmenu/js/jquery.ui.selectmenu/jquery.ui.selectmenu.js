...
(function($) {
  ...
  $.widget("ui.selectmenu", {
    ...
    _create: function() {
      ...
      this.newelementWrap = $( o.wrapperElement ).addClass("styled-select-wrap")
      ...
      this.listWrap = $( o.wrapperElement, {'id':this.ids[2]+"-wrap"} )
    ...
    _init: function() {
      ...
      this.element
        ...
        .each(function() {
          ...
          selectOptionData.push({
            value: opt.attr('value') !== null ? opt.attr('value') : "",
      ...
      if ( o.style == 'dropdown' ) {
        this.list.css("min-width", o.width); //BEN ADDED TO MAKE THE THINGS STRETCH
