...
?>
<table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#000000" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            <table width="100%" cellpadding="5" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td width:"30%">
                  &nbsp;
                </td>
        ...
        <tr valign="top">
          <td>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#000000" style="color: white;">
              ...
              <tr>
                <td colspan="2" bgcolor="#FFFFFF">
                  <font color="#000000"><b><?php print t('Shipping Details:'); ?></b></font>
                </td>
              </tr>
              <?php endif; ?>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <?php if($order->data['gift_wrapping']['is_a_gift'] == 1): ?>
                    <tr>
                      <td colspan="2">
                        <br /><b><?php print t('Giftwrapping:'); ?>&nbsp;</b>
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          <tr>
                            <td valign="top" nowrap="nowrap">To:</td>
                            <td width="98%"><?=$order->data['gift_wrapping']['recipient']?></td>
                          </tr>
                          <tr>
                            <td valign="top" nowrap="nowrap">From:</td>
                            <td width="98%"><?=$order->data['gift_wrapping']['sender']?></td>
                          </tr>
                          <tr>
                            <td valign="top" nowrap="nowrap">Message:</td>
                            <td width="98%"><?=$order->data['gift_wrapping']['message']?></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
